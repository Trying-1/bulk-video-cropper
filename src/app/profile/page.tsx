...
import { clearUserSessionCookie, getUserSessionCookie, getAppStateCookie, updateAppStateCookie } from '@/utils/cookies';
...
export default function Profile() {
  ...
  // Always set loading to false to prevent shimmer effect
    ...
    <div className="min-h-[calc(100vh-64px)] bg-white dark:bg-gray-800 flex flex-col md:flex-row -mt-[1px]">
      ...
      <div className="flex-1 p-6 overflow-auto">
        <div className="max-w-4xl mx-auto">
          {/* Page Header */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Profile Dashboard</h1>
