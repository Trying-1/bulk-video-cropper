      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              By accessing or using Bulk Video Cropper, you agree to comply with and be bound by these Terms of Service. If you do not agree with these Terms, you may not access or use our Services.
            </p>
            ...
            <p>
              Our Services allow you to upload, store, and process video content. You retain all rights to your User Content, but grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and display your User Content solely for the purpose of providing the Services to you.
            </p>
            <p>
