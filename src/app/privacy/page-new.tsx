        ...
        <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Cookies and Similar Technologies:</strong> We use cookies and similar technologies to maintain your session, remember your preferences, and provide a personalized experience. For more information, please see our <Link href="/cookies" className="text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300">Cookie Policy</Link>.</li>
            </ul>
