        ...
        <div className="max-w-4xl mx-auto px-6 bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="bg-gray-50 p-4 rounded-md mb-8">
            ...
            <ul className="space-y-1">
              ...
              <li><a href="#content" className="text-teal-600 hover:text-teal-800">4. User Content</a></li>
          ...
          <div className="space-y-8">
            ...
            <section id="services" className="p-4 border-l-4 border-teal-500 bg-gray-50">
              ...
              <p className="text-gray-700 mb-3">
                Bulk Video Cropper provides a video editing platform that enables users to:
              </p>
              <ul className="list-disc pl-6 text-gray-700 space-y-1">
                <li>Upload and edit multiple videos simultaneously</li>
                <li>Use manual cropping tools to adjust video content</li>
                <li>Create videos for various social media formats</li>
                <li>Export and download edited videos</li>
              </ul>
            </section>
