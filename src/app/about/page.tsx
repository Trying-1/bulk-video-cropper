        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-2xl text-gray-800 dark:text-gray-100 mb-6">
                Today, Bulk Video Cropper provides intuitive batch processing capabilities, allowing creators to transform their content for any platform in just a few clicks.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-teal-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-2xl text-gray-800 dark:text-gray-100 mb-6">
                Our mission is to revolutionize video editing through intuitive design. We believe that technology should work for creators, not against them.
              </p>
              <p className="text-2xl text-gray-800 dark:text-gray-100 mb-6">
